<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Work.ascx.cs" Inherits="ADefWebserver.Modules.ADefHelpDesk.Work" %>
...
<asp:Literal ID="JQueryCalendarJavaScript4" runat="server" />
    ...
    <table>
        <tr>
            <td valign="top">
                ...
                &nbsp;
                <asp:Button ID="btnInsertComment" meta:resourcekey="btnInsertComment" runat="server" Font-Bold="True" OnClick="btnInsertComment_Click"
                    Text="Insert" />
                &nbsp;<br />
                ...
                <table align="center">
                    <tr>
                        <td bgcolor="#CCCCCC" rowspan="2">
                            <asp:Label ID="lblStart1" runat="server" Font-Bold="True" Text="Start" meta:resourcekey="lblStart" />
                        </td>
                        <td align="center">
                        <asp:Label ID="lblDate1" runat="server" Font-Bold="False" Text="Date" meta:resourcekey="lblDate" />
                        </td>
                        <td align="center">
                        <asp:Label ID="lblTime1" runat="server" Font-Bold="False" Text="Time" meta:resourcekey="lblTime" />
                        </td>
                        <td>
                            &nbsp;
                        </td>
                        <td bgcolor="#CCCCCC" rowspan="2">
                        <asp:Label ID="lblStop1" runat="server" Font-Bold="True" Text="Stop" meta:resourcekey="lblStop" />
                        </td>
                       <td align="center">
                    ...
                    <tr>
                        ...
                        <td nowrap="nowrap">
                            <asp:TextBox ID="txtStopDay" runat="server" Columns="8" Width="56px"></asp:TextBox>
                        </td>
                        <td>
        ...
        <tr>
            ...
            <td style="border: 1px solid #CCCCCC" align="center" class="style2">
                <asp:Label ID="lblDescription" runat="server" Font-Bold="True" Width="143px" 
                    Style="margin-left: 0px" meta:resourcekey="lblDescription" Text="Comment" />
            </td>
            <td style="border: 1px solid #CCCCCC" align="center">
                <asp:Label ID="lblUser" runat="server" Width="138px" meta:resourcekey="lblUser" Font-Bold="True" Text="User" />
            </td>
            <td style="border: 1px solid #CCCCCC" align="center">
                <asp:Label ID="lblTime" runat="server" Width="150px" meta:resourcekey="lblTime" Font-Bold="True" Text="Time" />
            </td>
        </tr>
    </table>
</asp:Panel>
    ...
    <table>
        <tr>
            <td valign="top" nowrap="nowrap">
                ...
                <asp:LinkButton ID="lnkBack" meta:resourcekey="lnkBack" runat="server" Font-Underline="True" OnClick="lnkBack_Click" Text="Back" />&nbsp;<asp:Image
                    ID="Image4" runat="server" ImageUrl="~/images/page_add.png" />
                <asp:LinkButton ID="lnkUpdate" meta:resourcekey="lnkUpdate" runat="server" Text="Update" Font-Underline="True"
                    OnClick="lnkUpdate_Click" />
                &nbsp;<asp:Image ID="Image5" runat="server" ImageUrl="~/images/page_delete.png" />
                <asp:LinkButton ID="lnkDelete" meta:resourcekey="lnkDelete" runat="server" OnClientClick='if (!confirm("Are you sure you want to delete?") ){return false;}'
                    ...
                    <tr>
                        <td bgcolor="#CCCCCC" rowspan="2">
                            <asp:Label ID="lblStart2" runat="server" Font-Bold="True" 
                                meta:resourcekey="lblStart" Text="Start" />
&nbsp;</td>
                        <td align="center">
                            <asp:Label ID="lblDate3" runat="server" Font-Bold="False" meta:resourcekey="lblDate" 
                                Text="Date" />
&nbsp;</td>
                        <td align="center">
                            <asp:Label ID="lblTime3" runat="server" Font-Bold="False" meta:resourcekey="lblTime" 
                                Text="Time" />
                            &nbsp;</td>
                        <td>
                            &nbsp;
                        ...
                        <td bgcolor="#CCCCCC" rowspan="2">
                            <asp:Label ID="lblStop2" runat="server" Font-Bold="True" meta:resourcekey="lblStop" 
                                Text="Stop" />
&nbsp;</td>
                        <td align="center">
                            <asp:Label ID="lblDate4" runat="server" Font-Bold="False" meta:resourcekey="lblDate" 
                                Text="Date" />
                            &nbsp;</td>
                        <td align="center">
                            <asp:Label ID="lblTime4" runat="server" Font-Bold="False" meta:resourcekey="lblTime" 
                                Text="Time" />
                            &nbsp;</td>
                    </tr>
                    <tr>
        ...
        <tr>
            <td colspan="2">
                &nbsp;<asp:Label ID="lblUserFooter" runat="server" Font-Bold="True" 
                    Text="User:" meta:resourcekey="lblUserFooter" />
                &nbsp;<asp:Label ID="lblDisplayUser" runat="server"></asp:Label>
                &nbsp;<asp:Label ID="lblInsertDateFooter" runat="server" Font-Bold="True" 
                    Text="Insert Date:" meta:resourcekey="lblInsertDateFooter" />&nbsp;<asp:Label ID="lblInsertDate" runat="server"></asp:Label>
                &nbsp;
                <br />
