...
<tr>
        ...
        <tr>
            <td>
                ...
                <asp:LinkButton ID="lnkNewTicket" resourcekey="lnkNewTicket" runat="server" Font-Underline="True" OnClick="lnkNewTicket_Click">New Ticket</asp:LinkButton>
            </td>
            <td>
                <asp:Image ID="imgExitingTickets" runat="server" ImageUrl="~/DesktopModules/ADefHelpDesk/images/layout.png" />
                <asp:LinkButton ID="lnkExistingTickets" resourcekey="lnkExistingTickets" runat="server" Font-Underline="True" OnClick="lnkExistingTickets_Click">Existing Tickets</asp:LinkButton>
            </td>
            <td>
                <asp:Image ID="imgAdministrator" runat="server" ImageUrl="~/DesktopModules/ADefHelpDesk/images/cog.png" />
                <asp:LinkButton ID="lnkAdministratorSettings" resourcekey="lnkAdministratorSettings" runat="server" Font-Underline="True"
        ...
        <tr>
            <td valign="top" title="Ticket">
                <table>
                    <tr>
                        <td align="center" >
                            <asp:Button ID="btnSave" resourcekey="btnSave" runat="server" ForeColor="Red" OnClick="btnSave_Click" Text="Save"
                                Width="63px" />
                        </td>
                        ...
                        <tr>
                            <td>
                                <asp:Button ID="btnComments" runat="server" OnClick="btnComments_Click" Text="Comments"
                                    ...
                                    ForeColor="Red" Width="100px" resourcekey="btnComments" />
                                <asp:Button ID="btnWorkItems" runat="server" BackColor="#F0F0F0" BorderColor="#CCCCCC"
                                    BorderStyle="Outset" OnClick="btnWorkItems_Click" Text="Work" Width="100px" resourcekey="btnWorkItems" />
                                <asp:Button ID="btnLogs" runat="server" BackColor="#F0F0F0" BorderColor="#CCCCCC"
                                    BorderStyle="Outset" OnClick="btnLogs_Click" Text="Logs" Width="100px" resourcekey="btnLogs" />
                            </td>
                        </tr>
                    </table>
