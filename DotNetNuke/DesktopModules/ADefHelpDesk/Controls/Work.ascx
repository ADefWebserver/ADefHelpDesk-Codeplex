                ...
                <table align="center">
                    ...
                    <tr>
                        <td nowrap="nowrap">
                            ...
                            <b>
                                <asp:HyperLink ID="cmdtxtStartCalendar1" runat="server" ImageUrl="~/DesktopModules/ADefHelpDesk/images/calendar.png"></asp:HyperLink>
                            </b>
                        </td>
                        <td>
                        ...
                        <td nowrap="nowrap">
                            ...
                            <b>
                                <asp:HyperLink ID="cmdtxtStartCalendar2" runat="server" ImageUrl="~/DesktopModules/ADefHelpDesk/images/calendar.png"></asp:HyperLink>
                            </b>
                        </td>
                        <td>
    ...
    <table cellpadding="0" cellspacing="0" bgcolor="WhiteSmoke" width="540px">
        <tr>
            ...
            <td style="border: 1px solid #CCCCCC" align="center" class="style2">
                <asp:Label ID="lblDescription" runat="server" Font-Bold="True" Width="147px" Style="margin-left: 0px">Comment</asp:Label>
            </td>
            <td style="border: 1px solid #CCCCCC" align="center">
                <asp:Label ID="lblUser" runat="server" Width="138px" Font-Bold="True">User</asp:Label>
            </td>
            <td style="border: 1px solid #CCCCCC" align="center">
    ...
    <table>
        <tr>
            <td valign="top" nowrap="nowrap">
                ...
                <asp:LinkButton ID="lnkBack" runat="server" Font-Underline="True" OnClick="lnkBack_Click">Back</asp:LinkButton>&nbsp;<asp:Image
                    ID="Image4" runat="server" ImageUrl="~/DesktopModules/ADefHelpDesk/images/page_add.png" />
                <asp:LinkButton ID="lnkUpdate" runat="server" Text="Update" Font-Underline="True"
                    OnClick="lnkUpdate_Click" />
                &nbsp;<asp:Image ID="Image5" runat="server" ImageUrl="~/DesktopModules/ADefHelpDesk/images/page_delete.png" />
                <asp:LinkButton ID="lnkDelete" runat="server" OnClientClick='if (!confirm("Are you sure you want to delete?") ){return false;}'
                ...
                <table align="center">
                    ...
                    <tr>
                        <td nowrap="nowrap">
                            ...
                            <b>
                                <asp:HyperLink ID="cmdtxtStartCalendar3" runat="server" ImageUrl="~/DesktopModules/ADefHelpDesk/images/calendar.png"></asp:HyperLink>
                            </b>
                        </td>
                        <td>
                        ...
                        <td nowrap="nowrap">
                            ...
                            <b>
                                <asp:HyperLink ID="cmdtxtStartCalendar4" runat="server" ImageUrl="~/DesktopModules/ADefHelpDesk/images/calendar.png"></asp:HyperLink>
                            </b>
                        </td>
                        <td>
